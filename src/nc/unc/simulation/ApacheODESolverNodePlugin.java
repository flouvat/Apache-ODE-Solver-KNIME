 ...
 * @author Flouvat
 */
public class ApacheODESolverNodePlugin extends Plugin {
    // The shared instance.
    private static ApacheODESolverNodePlugin plugin;

    /**
     * The constructor.
     */
    public ApacheODESolverNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ApacheODESolverNodePlugin getDefault() {
        return plugin;
    }
